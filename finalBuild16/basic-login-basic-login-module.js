...
BasicLoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BasicLoginComponent, selectors: [["app-basic-login"]], decls: 54, vars: 9, consts: [[1, "login-block"], [1, "container"], [1, "row"], [1, "col-sm-12"], ["action", "javascript:", 1, "md-float-material", "form-material"], [1, "col-sm-5"], [1, "card"], [1, "card-body"], ["src", "assets/images/SUK-Name.gif", 1, "imagesize"], [1, "row", "m-b-20"], [1, "col-md-12"], [1, "text-center"], [1, "form-group", "form-primary", "form-static-label"], ["type", "text", "name", "User_Name", "pattern", "^[A-Za-z\\s .]+$", "title", "Please Enter User Name", "maxlength", "12", "minlength", "12", "id", "User_Name", "required", "", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "form-bar"], [1, "float-label"], ["class", "invalid", 4, "ngIf"], ["name", "password", "pattern", "(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{8,}", "minlength", "8", "maxlength", "12", "title", "Must contain at least one number, one uppercase, lowercase latter and at least 8 characters", 1, "form-control", 2, "width", "90%", 3, "type", "ngModel", "ngModelChange"], ["toggle", "#password-field", 1, "fa", "fa-fw", "fa-eye", "field-icon", "toggle-password", 2, "font-size", "20px", "color", "#262d38", "cursor", "pointer", 3, "click"], [1, "row", "m-t-25", "text-left"], [1, "col-12"], [1, "forgot-phone", "text-right", "f-right"], [1, "text-right", "f-w-600", 3, "routerLink"], [1, "row", "m-t-30"], ["mdbRippleRadius", "", 1, "btn", "btn-primary", "btn-md", "btn-block", "waves-light", "text-center", "m-b-20", 3, "click"], [2, "color", "white"], [2, "text-decoration", "underline", "color", "red", 3, "routerLink"], [1, "col-md-8", "text-left", "f-left"], [1, "text-center", "m-b-0"], [1, "col-md-4", "text-right", "f-right"], ["src", "assets/images/bways.png", "alt", "small-logo.png", 1, "logosize", 2, "width", "100%"], [1, "invalid"]], template: function BasicLoginComponent_Template(rf, ctx) { if (rf & 1) {
